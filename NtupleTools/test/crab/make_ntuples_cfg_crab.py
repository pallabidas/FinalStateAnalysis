...
cmsswversion=os.environ['CMSSW_BASE']
...
options = TauVarParsing.TauVarParsing(
    ...
    hzz=0,
    zh=0,
    paramFile='/{0}/src/FinalStateAnalysis/NtupleTools/python/parameters/ztt.py'.format(cmsswversion),
    runWZ=0,
    isLFV=0,
